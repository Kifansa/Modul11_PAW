  ...
  <section class="home pt-5 pb-5" id="home">
    <div class="row justify-content-evenly align-middle">
      ...
      <div class="col-10 col-md-4 d-none d-md-block">
        <img src="{{Vite::asset('resources/images/Foto.jpg')}}" class="img-fluid" alt="" id="foto-cv">
      </div>
    </div>
  </section>
    ...
    <div class="row justify-content-evenly mt-5">
      <div class="col-10 col-md-4">
        <div class="skill-card">
          <div class="img">
            <img src="{{Vite::asset('resources/images/gelembung.png')}}" class="w-auto img-fluid img">
          </div>
      ...
      <div class="col-md-4 col-10">
        <div class="skill-card">
          <div class="img">
            <img  src="{{Vite::asset('resources/images/krabby.png')}}" class="w-auto img-fluid img">
          </div>
          <div class="content mt-3">
            <h4>Memasak</h4>
            <p class="text-muted">
      ...
      <div class="col-md-4 col-10">
        <div class="skill-card">
          <div class="img">
            <img src="{{Vite::asset('resources/images/ubur-ubur.png')}}" class="w-auto img-fluid img" >
          </div>
          <div class="content mt-3">
  ...
  <section class="blog mt-5 pb-5" id="experience">
    ...
    <div class="row justify-content-evenly px-4 mt-4">
      <div class="blogpost col-md-4 col-10 mt-2 mt-md-0">
        <div class="card">
          <img src="{{Vite::asset('resources/images/gunung.png')}}" class="card-img-top rounded-4">
      ...
      <div class="blogpost col-md-4 col-10 mt-5 mt-md-0 website all">
        <div class="card">
          <img src="{{Vite::asset('resources/images/laut.png')}}" class="card-img-top rounded-4">
          <div class="card-body px-4">
            <p>7 Oktober 2078</p>
            <h4 class="card-title">
      ...
      <div class="blogpost col-md-4 col-10 mt-5 mt-md-0 webapp all">
        <div class="card">
          <img src="{{Vite::asset('resources/images/luar-angkasa.png')}}" class="card-img-top rounded-4">
          <div class="card-body px-4">
            <p>8 November 3021</p>
            <h4 class="card-title">
